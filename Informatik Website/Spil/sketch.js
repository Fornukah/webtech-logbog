...
function preload(){
  background = createImg('/spil/resources/background.png',''); // Defines the picture for the background
	background.hide(); // Hides the background picture
  ball = createImg('/spil/resources/ball.png',''); // Defines the picture for the ball
  ball.hide(); // Hides the ball picture
  PlayerHit = createAudio('/spil/resources/HitPlayer.mp3',''); // Defines the audio for Player Hit
  PlayerHit.hide(); // Hides the player hit sound
  SideHit = createAudio('/spil/resources/HitSide.mp3',''); // Defines the audio for Side Hit
  SideHit.hide(); // Hides the side hit sound
  TopHit = createAudio('/spil/resources/HitTop.mp3','') // Defines the audio for Top Hit
